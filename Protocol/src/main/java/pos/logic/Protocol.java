...
public class Protocol {
    ...
    public static final int MEDICO_FILTRAR=106;
    ...
    public static final int FARMACEUTA_FILTRAR=206;
    ...
    public static final int PACIENTE_FILTRAR=306;
    ...
    public static final int MEDICAMENTO_FILTRAR=406;
    ...
    public static final int RECETA_FILTRAR=506;
    public static final int RECETA_FILTRAR_2=507;
    ...
    public static final int USUARIO_FILTRAR=606;
    public static final int USUARIO_GET=606;
